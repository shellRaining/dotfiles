...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'undotree', 'vim-illuminate'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'undotree', 'vim-illuminate'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
